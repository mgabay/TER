...
Elapsed real time =   2,00 sec. (tree size =  0,04 MB, solutions = 1)
...
Elapsed real time =   2,74 sec. (tree size =  0,07 MB, solutions = 1)
...
Elapsed real time =   3,35 sec. (tree size =  0,02 MB, solutions = 1)
...
Parallel b&c, 2 threads:
  Real time             =    3,33
  Sync time (average)   =    0,12
  Wait time (average)   =    0,49
                          -------
Total (root+branch&cut) =    3,48 sec.
